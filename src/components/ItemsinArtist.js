...
export default function ItemsInArt() {
const sampleData = [
    // {
    //     "name": "NFT#1",
...
async function fetchArtistCollections() {
    ...
    //create an NFT Token
    let transaction = await contract.fetchArtistCollections()
...
<section className="overflow-hidden text-gray-700 ">
  ...
  <div style={{padding:"10px", margin:"5px"}} className="rounded-lg shadow-lg bg-white max-w-sm">
    <a href="#!">
      <img className="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/184.jpg" alt=""/>
    </a>
    <div className="p-6">
      <h5 className="text-gray-900 text-xl font-medium mb-2">Pirate Nation</h5>
